...
/**
 * <p>The {@link KerberosFilter} enables protecting web application
 ...
 * {@link KerberosFilter} will take all the properties that start with the prefix #PREFIX#, it will remove
 ...
 * </p>
 * For subclasses of KerberosFilter that want additional control over the
...
public class KerberosFilter implements Filter {
  ...
  private static Logger LOG = LoggerFactory.getLogger(KerberosFilter.class);
  ...
  /**
   * Returns the configuration properties of the {@link KerberosFilter}
...
/*
          ...
          user.setDisplayName(authToken.getUserName());
          SpitfireSessions.login(httpRequest, user);
*/
