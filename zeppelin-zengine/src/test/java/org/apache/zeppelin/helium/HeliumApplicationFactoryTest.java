...
public class HeliumApplicationFactoryTest implements JobListenerFactory {
  ...
  public void testUnloadOnParagraphRemove() throws IOException {
    ...
    Note note1 = notebook.createNote(null);
    factory.setInterpreters("user", note1.id(), factory.getDefaultInterpreterSettingList());
  ...
  public void testUnloadOnInterpreterUnbind() throws IOException {
    ...
    Note note1 = notebook.createNote(null);
    notebook.bindInterpretersToNote("user", note1.id(), factory.getDefaultInterpreterSettingList());
    ...
    notebook.bindInterpretersToNote("user", note1.id(), new LinkedList<String>());
